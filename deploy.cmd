...
IF !ERRORLEVEL! NEQ 0 goto error
env\scripts\python -m pip install setuptools --upgrade
IF !ERRORLEVEL! NEQ 0 goto error
...
:: 4. Create instance config file

MKDIR "%DEPLOYMENT_TARGET%\instance"
TOUCH "%DEPLOYMENT_TARGET%\instance\config.py"
